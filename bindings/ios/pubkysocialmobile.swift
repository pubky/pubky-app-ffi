...
#if canImport(pubkysocialmobileFFI)
import pubkysocialmobileFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_pubkysocialmobile_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_pubkysocialmobile_rustbuffer_free(self, $0) }
    }
}
...
public class EventNotifier: EventNotifierProtocol {
    ...
    deinit {
        try! rustCall { uniffi_pubkysocialmobile_fn_free_eventnotifier(pointer, $0) }
    }
...
fileprivate struct FfiConverterCallbackInterfaceEventListener {
    private static let initCallbackOnce: () = {
        ...
        try! rustCall { (err: UnsafeMutablePointer<RustCallStatus>) in
            uniffi_pubkysocialmobile_fn_init_callback_eventlistener(foreignCallbackCallbackInterfaceEventListener, err)
        }
    }()
...
public func auth(url: String, secretKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_auth(
...
public func cleanupFile(pubky: String, fileId: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_cleanup_file(
...
public func cleanupPost(pubky: String, postId: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_cleanup_post(
        FfiConverterString.lower(pubky),
...
public func cleanupUser(pubky: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_cleanup_user(
...
public func createBookmark(pubky: String, postId: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_bookmark(
        FfiConverterString.lower(pubky),
        FfiConverterString.lower(postId),$0)
}
    )
...
public func createFile(pubky: String, file: PubkyAppFile)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_file(
        FfiConverterString.lower(pubky),
...
public func createFollow(followerPubky: String, followeePubky: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_follow(
...
public func createPost(userId: String, post: PubkyAppPost)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_post(
...
public func createRecoveryFile(secretKey: String, passphrase: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_recovery_file(
...
public func createTag(pubky: String, label: String, postId: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_tag(
        FfiConverterString.lower(pubky),
...
public func createUser(secretKey: String, user: PubkyAppUser, homeserver: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_create_user(
        FfiConverterString.lower(secretKey),
...
public func decryptRecoveryFile(recoveryFile: String, passphrase: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_decrypt_recovery_file(
...
public func deleteBookmark(bookmarkUrl: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_delete_bookmark(
...
public func deleteFile(url: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_delete_file(
...
public func deleteFollow(followUrl: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_delete_follow(
...
public func deleteTag(tagUrl: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_delete_tag(
...
public func generateSecretKey()  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_generate_secret_key($0)
}
    )
}
...
public func get(url: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_get(
        FfiConverterString.lower(url),$0)
}
    )
}
...
public func getPublicKeyFromSecretKey(secretKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_get_public_key_from_secret_key(
        FfiConverterString.lower(secretKey),$0)
}
    )
}
...
public func list(url: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_list(
        FfiConverterString.lower(url),$0)
}
    )
}
...
public func parseAuthUrl(url: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_parse_auth_url(
        FfiConverterString.lower(url),$0)
}
    )
}
...
public func publish(recordName: String, recordContent: String, secretKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_publish(
...
public func publishHttps(recordName: String, target: String, secretKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_publish_https(
        FfiConverterString.lower(recordName),
...
public func put(url: String, content: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_put(
        FfiConverterString.lower(url),
...
public func removeEventListener()  {
    try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_remove_event_listener($0)
}
}
...
public func resolve(publicKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_resolve(
...
public func resolveHttps(publicKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_resolve_https(
        FfiConverterString.lower(publicKey),$0)
}
    )
}
...
public func session(pubky: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_session(
        FfiConverterString.lower(pubky),$0)
}
    )
}
...
public func setEventListener(listener: EventListener)  {
    try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_set_event_listener(
...
public func signIn(secretKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_sign_in(
        FfiConverterString.lower(secretKey),$0)
}
    )
}
...
public func signOut(secretKey: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_sign_out(
        FfiConverterString.lower(secretKey),$0)
}
    )
}
...
public func signUp(secretKey: String, homeserver: String)  -> [String] {
    return try!  FfiConverterSequenceString.lift(
        try! rustCall() {
    uniffi_pubkysocialmobile_fn_func_sign_up(
        FfiConverterString.lower(secretKey),
        FfiConverterString.lower(homeserver),$0)
}
    )
...
private var initializationResult: InitializationResult {
    ...
    let scaffolding_contract_version = ffi_pubkysocialmobile_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_auth() != 52585) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_cleanup_file() != 52924) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_cleanup_post() != 55396) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_cleanup_user() != 51041) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_bookmark() != 42080) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_file() != 56909) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_follow() != 64350) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_post() != 34715) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_recovery_file() != 24529) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_tag() != 64632) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_create_user() != 63132) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_decrypt_recovery_file() != 59696) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_delete_bookmark() != 12877) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_delete_file() != 27092) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_delete_follow() != 54438) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_delete_tag() != 54283) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_generate_secret_key() != 31132) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_get() != 9725) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_get_public_key_from_secret_key() != 8922) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_list() != 61348) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_parse_auth_url() != 25093) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_publish() != 32804) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_publish_https() != 16949) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_put() != 48599) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_remove_event_listener() != 58219) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_resolve() != 32186) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_resolve_https() != 64700) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_session() != 19565) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_set_event_listener() != 41572) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_sign_in() != 25563) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_sign_out() != 24707) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_func_sign_up() != 44212) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_pubkysocialmobile_checksum_method_eventlistener_on_event_occurred() != 64723) {
        return InitializationResult.apiChecksumMismatch
    }
